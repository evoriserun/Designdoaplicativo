...
export function LoginScreen({ onLogin, onNavigateToSignup, onNavigateBack, onNavigateToForgotPassword }: LoginScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-white flex flex-col h-dvh w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-40 h-40 bg-gradient-to-tr from-amber-50 to-transparent rounded-tr-full -z-10 opacity-60"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-right">
                <button
                  ...
                  className="text-[#E53935] text-sm hover:text-[#B71C1C] transition-colors font-bold"
                >
                  Esqueceu a senha?
                </button>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#E53935] to-[#C62828] text-white py-4 rounded-2xl font-bold shadow-lg shadow-[#E53935]/20 hover:shadow-xl hover:shadow-red-500/30 transition-all active:scale-[0.98] touch-manipulation mt-4 tracking-wide"
              >
                ENTRAR AGORA
              </button>
